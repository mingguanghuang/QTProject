...
//     // 连接按钮点击信号（QT5兼容的连接方式）
//     connect(micButton, SIGNAL(clicked()), this, SLOT(toggleVoiceRecognition()));
...
//     format.setSampleSize(16);  // QT5使用setSampleSize而不是setSampleFormat
...
//         QMessageBox::warning(this, "错误", "音频格式不被支持");
//         stopVoiceRecognition();
//         return;
//     }
...
//     connect(audioTimer, SIGNAL(timeout()), this, SLOT(processAudioData()));
